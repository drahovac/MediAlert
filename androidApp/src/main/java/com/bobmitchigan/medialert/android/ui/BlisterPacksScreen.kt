...
import com.bobmitchigan.medialert.viewModel.BlisterPacksActions
...
@Composable
internal fun BlisterPacksScreen(
    medicineId: Int?,
    navigationController: NavHostController,
    viewModel: BlisterPacksViewModel = getViewModel { parametersOf(medicineId) }
) {
    ...
    state?.let {
        BlisterPacksContent(medicine = it.medicine, viewModel) {
...
@Composable
private fun BlisterPacksContent(
    medicine: Medicine,
    actions: BlisterPacksActions,
    navigate: () -> Unit
) {
...
@Composable
private fun BlisterPackView(index: Int, pack: BlisterPack, actions: BlisterPacksActions) {
    Surface(
...
@Preview
@Composable
internal fun BlisterPacksScreenPreview() {
    BlisterPacksContent(
        medicine = Medicine(
            name = "Name",
...
@Preview
@Composable
internal fun BlisterPacksDialogPreview() {
    DetailDialog(
